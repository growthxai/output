...
export const listClientsStep = step( {
  ...
  description: 'Test GET request with API key auth',
...
export const createClientStep = step( {
  ...
  description: 'Test POST request with API key auth',
...
export const exportClientsStep = step( {
  ...
  description: 'Test GET request without authentication',
  outputSchema: httpBinResponseSchema,
  fn: async () => {
...
export const listContractsStep = step( {
  ...
  description: 'Test GET request with Basic auth',
  outputSchema: httpBinResponseSchema,
  fn: async () => {
...
export const createContractStep = step( {
  ...
  description: 'Test POST request with Basic auth',
  inputSchema: z.object( {
    clientId: z.string(),
    title: z.string(),
    value: z.number()
