...
/** Build a run-aware WorkflowNotFoundError. Shared by the describe and history paths. */
export const workflowNotFoundError = ( workflowId, runId ) => new WorkflowNotFoundError( runId ?
