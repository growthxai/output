...
Visit [https://zapier.com/app/assets/connections](https://zapier.com/app/assets/connections) and create connections to the apps you want to use.

![Zapier App Connections page listing authorized Slack workspaces](/cookbook/assets/zapier-app-connections.png)

Then install the Zapier SDK:
