...
| Exit code | Meaning |
|-----------|---------|
| `0` | A signal requested the shutdown and the worker drained cleanly |
| `1` | Startup failed, the Temporal connection was lost, or an uncaught error ended the process |
