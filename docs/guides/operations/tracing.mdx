...
- **LLM calls** - the loaded prompt (`name`, `fileDir`, `variables`, rendered config/messages), the result, token usage, and `cost`. Text calls also include merged `sources`; image calls do not;
  ...
  "children": [
    {
      ...
      "output": {
        ...
        "cost": { "type": "llm:usage", "modelId": "claude-sonnet-4-20250514", "total": 0.01 },
        "sources": []
      },
      "children": []
    }
