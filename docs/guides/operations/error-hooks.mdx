...
|--------|----------------|----------------------------------------|
| `activity` | A step, evaluator, or internal activity attempt fails (including attempts that Temporal will retry). | `activityInfo`, `workflowDetails`, `outputActivityKind` |
