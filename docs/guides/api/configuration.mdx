...
| `TEMPORAL_GRPC_MAX_MESSAGE_SIZE_BYTES` | `33554432` (32 MiB) | Max gRPC message size (send + receive) for the Temporal client. Raise if workflow result envelopes hit `RESOURCE_EXHAUSTED`. |
