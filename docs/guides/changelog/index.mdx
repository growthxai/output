...
The Output framework uses a fixed version group — `@outputai/core`, `@outputai/cli`, `@outputai/llm`, `@outputai/http`, `@outputai/evals`, `@outputai/output`, and `output-api` all share one version number and release together.
...
<Update label="v0.14.0" description="2026-09-22 - minor release">

See the [v0.13.0 - v0.14.0 migration guide](/migrations/v0.13.0-to-v0.14.0).
...
<Update label="v0.13.0" description="2026-09-14 - minor release">

See the [v0.12.0 - v0.13.0 migration guide](/migrations/v0.12.0-to-v0.13.0).
...
### `@outputai/cli`, `@outputai/credentials`, `output-api`
...
<Update label="v0.12.0" description="2026-09-02 - minor release">

See the [v0.11.0 - v0.12.0 migration guide](/migrations/v0.11.0-to-v0.12.0).
...
<Update label="v0.11.0" description="2026-08-12 - minor release">
...
- Added support for legacy and V2 workflow results from the API, including structured errors;
...
Updated `nanoid` from `5.1.9` to `5.1.16`
...
### `@outputai/cli`, `@outputai/credentials`
...
### `@outputai/cli`, `@outputai/core`, `@outputai/credentials`, `@outputai/evals`, `@outputai/http`, `@outputai/llm`, `@outputai/output`, `output-api`
...
### `@outputai/cli`, `@outputai/core`, `@outputai/http`, `@outputai/llm`, `output-api`
...
### `@outputai/core`, `@outputai/credentials`
...
### `@outputai/cli`, `@outputai/core`, `@outputai/llm`
...
### `@outputai/cli`, `@outputai/core`, `@outputai/credentials`
