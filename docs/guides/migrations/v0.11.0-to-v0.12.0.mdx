...
description: "Upgrading Output.ai projects from v0.11.0 to v0.12.0: prompt-only skills, merged tools, loaded prompt shape, and LLM trace details in @outputai/llm."
---
...
- Pass `stopWhen: stepCountIs(1)` on YAML-only grounding calls that must stay one-shot.
