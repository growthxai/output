...
description: "Upgrading Output.ai projects from v0.9.0 to v0.10.0: trace destinations now omit unavailable outputs instead of returning null values."
---

This guide covers the trace destination shape changes in v0.10.0. It affects workflow result payloads returned by `@outputai/core`, the API workflow result endpoints, and CLI JSON output.
