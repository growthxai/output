...
<CardGroup cols={1}>
  ...
  <Card title="v0.10.0 → v0.11.0" href="/migrations/v0.10.0-to-v0.11.0">
    Parsed component schemas, HTTP clients, hook event envelopes, API request logging, workflow result contracts, workflow and activity error handling, Temporal workflow runtime changes, Temporal TypeScript SDK v1.20.3, CLI `workflow test` rename, and strict prompt Liquid rendering.
  </Card>
</CardGroup>
