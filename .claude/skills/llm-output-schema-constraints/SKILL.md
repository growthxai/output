...
description: Zod schema constraints that Anthropic rejects or silently ignores when sent as structured-output tool definitions via aiSdk.Output.object(). Use when writing or reviewing Zod schemas passed to aiSdk.Output.object(), or debugging structured-output validation errors.
---
