...
const envVarSchema = z.object( {
  ...
  OUTPUT_WORKER_TELEMETRY_INTERNAL_MS: z.preprocess( coalesceEmptyString, z.coerce.number().int().nonnegative().default( 0 ) ),
...
export const workerTelemetryIntervalMs = envVars.OUTPUT_WORKER_TELEMETRY_INTERNAL_MS;
